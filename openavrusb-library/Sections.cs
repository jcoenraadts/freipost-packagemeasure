...
namespace HU320
{
    public partial class HU320
    {
        ...
        public event USER_rawDataReceivedEvent USER_rawDataReceived;
        public delegate void USER_rawDataReceivedEvent(object sender, byte[] data);

        private enum USER_Instr : byte
        {
            asyncReply = 0x10,
            startSampling = 0x11
        }
        ...
        /// <summary>
        /// Requests the ultrasonic devices to measure and return thier data
        /// </summary>
        public byte[] user_startSampling()
        {
            byte[] inData;

            bool replyOK = msgSendGetReply(section.user, (byte)USER_Instr.startSampling, out inData);
            return inData;
        }
